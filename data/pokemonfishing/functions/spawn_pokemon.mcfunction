# 7 squirtle
execute if score #pokemonfishing:pokemon.id pokemonfishing.temp matches 7 run function pokemonfishing:spawn_pokemon/7_squirtle

# 54 psyduck
execute if score #pokemonfishing:pokemon.id pokemonfishing.temp matches 54 run function pokemonfishing:spawn_pokemon/54_psyduck

# 55 golduck
execute if score #pokemonfishing:pokemon.id pokemonfishing.temp matches 55 run function pokemonfishing:spawn_pokemon/55_golduck
...
# 130 gyarados
execute if score #pokemonfishing:pokemon.id pokemonfishing.temp matches 130 run function pokemonfishing:spawn_pokemon/130_gyarados
...
# 271 lombre
execute if score #pokemonfishing:pokemon.id pokemonfishing.temp matches 271 run function pokemonfishing:spawn_pokemon/271_lombre
...
# 393 piplip
execute if score #pokemonfishing:pokemon.id pokemonfishing.temp matches 393 run function pokemonfishing:spawn_pokemon/393_piplup

# 501 oshawott
execute if score #pokemonfishing:pokemon.id pokemonfishing.temp matches 501 run function pokemonfishing:spawn_pokemon/501_oshawott
...
# 656 froakie
execute if score #pokemonfishing:pokemon.id pokemonfishing.temp matches 656 run function pokemonfishing:spawn_pokemon/656_froakie

# 728 popplio
execute if score #pokemonfishing:pokemon.id pokemonfishing.temp matches 728 run function pokemonfishing:spawn_pokemon/728_popplio

# 781 dhelmise
execute if score #pokemonfishing:pokemon.id pokemonfishing.temp matches 781 run function pokemonfishing:spawn_pokemon/781_dhelmise

# 816 sobble
execute if score #pokemonfishing:pokemon.id pokemonfishing.temp matches 816 run function pokemonfishing:spawn_pokemon/816_sobble