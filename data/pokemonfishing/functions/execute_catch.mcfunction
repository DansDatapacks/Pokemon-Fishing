...
# tag pokemon
execute if score #pokemonfishing:pokemon.spawned pokemonfishing.temp matches 1.. run tag @e[type=cobblemon:pokemon,tag=!pokemonfishing.ignore,sort=nearest,limit=1,distance=..3] add pokemonfishing.pokemon.execute
